	...
	_createClass(App, [{
		...
		value: function render() {
			...
			if (calendar && calendars) {
				...
				return React.createElement(
					'div',
					{ 'data-iframe-height': true, 'data-jsx': 1933473363
					},
					activeEventNode,
					React.createElement(
						'h1',
					...
					(groupedCalendarListItems || calendarListItems) && React.createElement(
						'div',
						{ className: 'calendar-nav-container', 'data-jsx': 1933473363
						},
						React.createElement(
							'h2',
							{
						...
						React.createElement(
							'nav',
							{ className: 'calendar-nav', 'data-jsx': 1933473363
							},
					...
					React.createElement(_JSXStyle, {
						styleId: 1933473363,
						css: 'h1[data-jsx="1933473363"] {font-size: 2.75em;font-weight: 500;text-align: center;}h2[data-jsx="1933473363"] {font-size: 2em;font-weight: normal;}a.active[data-jsx="1933473363"] {pointer-events: none;text-decoration: none;cursor: auto;color: rgba($text-color, $primary-text);}.calendar-nav-container[data-jsx="1933473363"] {padding: 0 2em;}@media (min-width: ' + BREAKPOINTS.SMALL_DESKTOP + 'px) {.calendar-nav-container[data-jsx="1933473363"] {padding: 0 3em;}}@media (min-width: ' + BREAKPOINTS.LARGE_DESKTOP + 'px) {.calendar-nav-container[data-jsx="1933473363"] {padding: 0 4em;}}.calendar-nav[data-jsx="1933473363"] {display:-webkit-flex; display:flex;-webkit-flex-direction: row;-moz-flex-direction: row;flex-direction: row;-webkit-flex-wrap: wrap;-moz-flex-wrap: wrap;flex-wrap: wrap;justify-content: space-around;}.calendar-nav[data-jsx="1933473363"] section[data-jsx="1933473363"] {-webkit-flex-grow: 0;-moz-flex-grow: 0;flex-grow: 0;-webkit-flex-shrink: 1;-moz-flex-shrink: 1;flex-shrink: 1;min-width: 15em;}@media print {h1[data-jsx="1933473363"] {margin: 0;font-size: 2em;}h2[data-jsx="1933473363"] {font-size: 1.5em;}.calendar-nav-container[data-jsx="1933473363"] {display: none;}}'
					})
				);
			} else {
