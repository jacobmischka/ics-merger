  ...
  Component.prototype = {
      ...
      if (name) {
        ...
        for (; i < len; i++) {
          if (comps[i][NAME_INDEX] === name) {
            var result = this$1._hydrateComponent(i);
            return result;
          }
        }
      } else {
    ...
    getFirstProperty: function(name) {
      ...
      if (name) {
        ...
        for (; i < len; i++) {
          if (props[i][NAME_INDEX] === name) {
            var result = this$1._hydrateProperty(i);
            return result;
          }
        }
      } else {
      ...
      if (typeof(nameOrObject) === 'string') {
        for (; i < len; i++) {
          if (objects[i][NAME_INDEX] === nameOrObject) {
            this$1._removeObjectByIndex(jCalIndex, cached, i);
            return true;
          }
        }
      } else if (cached) {
...
ICAL.Property = (function() {
  ...
  Property.prototype = {
    ...
    getValues: function() {
      ...
      for (; i < len; i++) {
        result[i] = this$1._hydrateValue(i);
      }
    ...
    setValues: function(values) {
      ...
      if (this.isDecorated) {
        for (; i < len; i++) {
          this$1._setDecoratedValue(values[i], i);
        }
      } else {
        for (; i < len; i++) {
          this$1.jCal[VALUE_INDEX + i] = values[i];
        }
      }
    },
...
(function() {
  ...
  ICAL.Timezone.prototype = {
    ...
    utcOffset: function utcOffset(tt) {
      ...
      for (;;) {
        var change = ICAL.helpers.clone(this$1.changes[change_num], true);
        ...
        if (change_num >= this$1.changes.length) {
          break;
        }
      }
    ...
    _ensureCoverage: function(aYear) {
      ...
      if (!this.changes.length || this.expandedUntilYear < aYear) {
        ...
        for (; compIdx < compLen; compIdx++) {
          this$1._expandComponent(
            subcomps[compIdx], changesEndYear, this$1.changes
          );
        }
  ...
  ICAL.Recur.prototype = {
    ...
    toJSON: function() {
      ...
      for (var k in this.parts) {
        ...
        var kparts = this$1.parts[k];
        if (Array.isArray(kparts) && kparts.length == 1) {
          res[k.toLowerCase()] = kparts[0];
        } else {
          res[k.toLowerCase()] = ICAL.helpers.clone(this$1.parts[k]);
        }
      }
  ...
  icalrecur_iterator.prototype = {
    ...
    init: function icalrecur_iterator_init() {
      ...
      if (this.rule.freq == "YEARLY") {
        for (;;) {
          this$1.expand_year_days(this$1.last.year);
          if (this$1.days.length > 0) {
            break;
          }
          this$1.increment_year(this$1.rule.interval);
        }
      ...
      if (this.rule.freq == "MONTHLY" && this.has_by_data("BYDAY")) {
        ...
        for (var i in this.by_data.BYDAY) {
          ...
          this$1.last = initLast.clone();
          var bydayParts = this$1.ruleDayOfWeek(this$1.by_data.BYDAY[i]);
          var pos = bydayParts[0];
          var dow = bydayParts[1];
          var dayOfMonth = this$1.last.nthWeekDay(dow, pos);
          ...
          if (dayOfMonth > daysInMonth || dayOfMonth <= 0) {
            ...
            while (dayOfMonth > daysInMonth || dayOfMonth <= 0) {
              this$1.increment_month();
              daysInMonth = ICAL.Time.daysInMonth(this$1.last.month, this$1.last.year);
              dayOfMonth = this$1.last.nthWeekDay(dow, pos);
            }
          }

          this$1.last.day = dayOfMonth;
          if (!tempLast || this$1.last.compare(tempLast) < 0) {
            tempLast = this$1.last.clone();
          }
        }
    ...
    _byDayAndMonthDay: function(isInit) {
      ...
      while (!dataIsValid && monthsCounter) {
        ...
        for (var dayIdx = 0; dayIdx < dayLen; dayIdx++) {
          var parts = this$1.ruleDayOfWeek(byDay[dayIdx]);
          var pos = parts[0];
          var dow = parts[1];

          this$1.last.day = lastDay;
          if (this$1.last.isNthWeekDay(dow, pos)) {
      ...
      if (this.has_by_data("BYDAY") && this.has_by_data("BYMONTHDAY")) {
        ...
        if (this.has_by_data("BYSETPOS")) {
          ...
          for (var day = 1; day <= daysInMonth; day++) {
            this$1.last.day = day;
            if (this$1.is_day_in_byday(this$1.last)) {
              setpos_total++;
              if (day <= last_day) {
                setpos++;
              }
        ...
        for (var day = this.last.day + 1; day <= daysInMonth; day++) {
          ...
          if (this$1.is_day_in_byday(this$1.last)) {
            if (!this$1.has_by_data("BYSETPOS") ||
                this$1.check_set_position(++setpos) ||
                this$1.check_set_position(setpos - setpos_total - 1)) {
    ...
    next_weekday_by_week: function next_weekday_by_week() {
      ...
      for (;;) {
        var tt = new ICAL.Time();
        this$1.by_indices.BYDAY++;

        if (this$1.by_indices.BYDAY == Object.keys(this$1.by_data.BYDAY).length) {
          this$1.by_indices.BYDAY = 0;
          end_of_data = 1;
        }

        var coded_day = this$1.by_data.BYDAY[this$1.by_indices.BYDAY];
        var parts = this$1.ruleDayOfWeek(coded_day);
        var dow = parts[1];

        dow -= this$1.rule.wkst;

        if (dow < 0) {
          dow += 7;
        }

        tt.year = this$1.last.year;
        tt.month = this$1.last.month;
        tt.day = this$1.last.day;

        var startOfWeek = tt.startDoyWeek(this$1.rule.wkst);
         ...
         */
        this$1.last.year = next.year;
        this$1.last.month = next.month;
        this$1.last.day = next.day;
    ...
    increment_monthday: function increment_monthday(inc) {
      ...
      for (var i = 0; i < inc; i++) {
        var daysInMonth = ICAL.Time.daysInMonth(this$1.last.month, this$1.last.year);
        this$1.last.day++;

        if (this$1.last.day > daysInMonth) {
          this$1.last.day -= daysInMonth;
          this$1.increment_month();
        }
      }
    },
    ...
    expand_year_days: function expand_year_days(aYear) {
      ...
      for (var p in rules) {
        ...
        if (rules.hasOwnProperty(p)) {
          var part = rules[p];
          if (part in this$1.rule.parts) {
            parts[part] = this$1.rule.parts[part];
          }
        }
      }
      ...
      if ("BYMONTH" in parts && "BYWEEKNO" in parts) {
        ...
        for (var monthIdx = 0; monthIdx < this.by_data.BYMONTH.length; monthIdx++) {
          var month = this$1.by_data.BYMONTH[monthIdx];
          t.month = month;
          t.day = 1;
          var first_week = t.weekNumber(this$1.rule.wkst);
          t.day = ICAL.Time.daysInMonth(month, aYear);
          var last_week = t.weekNumber(this$1.rule.wkst);
        ...
        for (var weekIdx = 0; weekIdx < this.by_data.BYWEEKNO.length && valid; weekIdx++) {
          var weekno = this$1.by_data.BYWEEKNO[weekIdx];
          if (weekno < 52) {
      ...
      if (partCount == 0) {
        ...
        for (var monthkey in this.by_data.BYMONTH) {
          ...
          var t2 = this$1.dtstart.clone();
          t2.year = aYear;
          t2.month = this$1.by_data.BYMONTH[monthkey];
          t2.isDate = true;
        ...
        for (var monthdaykey in this.by_data.BYMONTHDAY) {
          ...
          var t3 = this$1.dtstart.clone();
          var day_ = this$1.by_data.BYMONTHDAY[monthdaykey];
          if (day_ < 0) {
        ...
        for (var monthkey in this.by_data.BYMONTH) {
          ...
          var month = this$1.by_data.BYMONTH[monthkey];
          var daysInMonth = ICAL.Time.daysInMonth(month, aYear);

          t.year = aYear;
          t.month = this$1.by_data.BYMONTH[monthkey];
          t.day = 1;
          t.isDate = true;
          ...
          if (this$1.has_by_data("BYSETPOS")) {
            ...
            for (var day = 1; day <= daysInMonth; day++) {
              t.day = day;
              if (this$1.is_day_in_byday(t)) {
                by_month_day.push(day);
              }
            }

            for (var spIndex = 0; spIndex < by_month_day.length; spIndex++) {
              if (this$1.check_set_position(spIndex + 1) ||
                  this$1.check_set_position(spIndex - by_month_day.length)) {
                this$1.days.push(doy_offset + by_month_day[spIndex]);
              }
            }
          } else {
            for (var daycodedkey in this.by_data.BYDAY) {
              ...
              var coded_day = this$1.by_data.BYDAY[daycodedkey];
              var bydayParts = this$1.ruleDayOfWeek(coded_day);
              var pos = bydayParts[0];
              var dow = bydayParts[1];
              var month_day;
              ...
              if (pos == 0) {
                for (var day = first_matching_day; day <= daysInMonth; day += 7) {
                  this$1.days.push(doy_offset + day);
                }
              } else if (pos > 0) {
                month_day = first_matching_day + (pos - 1) * 7;

                if (month_day <= daysInMonth) {
                  this$1.days.push(doy_offset + month_day);
                }
              } else {
        ...
        for (var daykey in expandedDays) {
          ...
          if (this$1.by_data.BYMONTHDAY.indexOf(tt.day) >= 0) {
            this$1.days.push(day);
          }
        }
      } else if (partCount == 3 &&
                 "BYDAY" in parts &&
        ...
        for (var daykey in expandedDays) {
          ...
          if (this$1.by_data.BYMONTH.indexOf(tt.month) >= 0 &&
              this$1.by_data.BYMONTHDAY.indexOf(tt.day) >= 0) {
            this$1.days.push(day);
          }
        }
        ...
        for (var daykey in expandedDays) {
          ...
          var day = expandedDays[daykey];
          var tt = ICAL.Time.fromDayOfYear(day, aYear);
          var weekno = tt.weekNumber(this$1.rule.wkst);

          if (this$1.by_data.BYWEEKNO.indexOf(weekno)) {
            this$1.days.push(day);
          }
        }
      } else if (partCount == 3 &&
    ...
    expand_by_day: function expand_by_day(aYear) {
      ...
      for (var daykey in this.by_data.BYDAY) {
        ...
        var day = this$1.by_data.BYDAY[daykey];
        var parts = this$1.ruleDayOfWeek(day);
        var pos = parts[0];
        var dow = parts[1];
    ...
    sort_byday_rules: function icalrecur_sort_byday_rules(aRules, aWeekStart) {
      ...
      for (var i = 0; i < aRules.length; i++) {
        for (var j = 0; j < i; j++) {
          var one = this$1.ruleDayOfWeek(aRules[j])[1];
          var two = this$1.ruleDayOfWeek(aRules[i])[1];
          one -= aWeekStart;
          two -= aWeekStart;
          if (one < 0) { one += 7; }
          if (two < 0) { two += 7; }
  ...
  RecurExpansion.prototype = {
    ...
    next: function() {
      ...
      while (true) {
        ...
        next = this$1.ruleDate;
        iter = this$1._nextRecurrenceIter(this$1.last);
        ...
        if (this$1.exDate) {
          compare = this$1.exDate.compare(this$1.last);
    ...
    _init: function(component) {
      ...
      if (component.hasProperty('rrule')) {
        ...
        for (; i < len; i++) {
          ...
          iter = rule.iterator(this$1.dtstart);
          this$1.ruleIterators.push(iter);
    ...
    process: function(ical) {
      ...
      for (; i < len; i++) {
        ...
        switch (component.name) {
          case 'vtimezone':
            if (this$1.parseTimezone) {
              var tzid = component.getFirstPropertyValue('tzid');
              if (tzid) {
                this$1.ontimezone(new ICAL.Timezone({
                  tzid: tzid,
                  component: component
                }));
              }
            ...
            break;
          case 'vevent':
            if (this$1.parseEvent) {
              this$1.onevent(new ICAL.Event(component));
            }
            break;
          default:
            continue;
